pfDB["quests"]["enUS-turtle"] = {
  [172] = {
    ["D"] = "你愿意在孤儿院帮助我们吗?  祝福你，我的朋友; 你在儿童周期间的帮助将是无价的。$B$B拿着这个哨子。 您只能在很短的时间内使用它——通常不超过儿童周本身  W当你使用它时，你将能够与你同意照顾的孩子交谈。再次使用它将会解散这个孩子。$B$B无论如何 $N - 用哨子来迎接你的孩子吧!我相信孩子一定非常渴望见到你。",
    ["O"] = "在儿童周期间，用兽人孤儿哨子和你将要照看的孩子交谈。",
    ["T"] = "儿童周",
  },
  [236] = {
    ["D"] = "几周前, 我派守夜人卡拉汉和其他几个人去暮色森林北部边界对付狼群的侵扰。 我已经有一段时间没有他的消息了。 如果他听从我的指示，他就会在从夜色镇往北的路上露营。 $B$B如果你正好路过那条路，请去看看他，并告诉他我正在等待他的进展报告。",
    ["O"] = "和守夜人卡拉汉谈谈。",
    ["T"] = "守夜人卡拉汉",
  },
  [807] = {
    ["D"] = "我的侦察员报告说一些野生动物已经被恶魔感染了。 它们像普通的野兽一样在同类中游荡, 但邪恶的力量在它们身上流淌。 它们体内都有一颗被黑暗魔法烧焦的心。必须消灭这些野兽！如果你在探索过程中发现了这样的动物，杀死它并收集它烧焦的心脏。把你在旅行中发现的东西给我拿来研究，然后我会销毁它们。",
    ["O"] = "在剃刀岭给奥戈尼尔带来5颗烧焦的心",
    ["T"] = "杜隆塔尔洗涤",
  },
  [810] = {
    ["D"] = "你最好了解一下这片土地有多危险， $c. 这里的野生动物能教会我们不可思议的东西, 如果我们有足够的智慧去听它们的课。在杜隆塔尔，蝎子是一个完美的生存例子。 虽然土地变得越来越贫瘠，越来越无情， 但它们坚硬的甲壳却保护它们免受烈日的暴晒和猎人武器的致命伤害。 我们应该学习它们那样能利用优势来应对环境。从巨钳蝎身上给我带回来6个小蝎子甲壳, $N, 我会给你报酬的。",
    ["O"] = "带回6个小蝎子甲壳虫给森金村的考格汉。",
    ["T"] = "学习生存",
  },
  [811] = {
    ["D"] = "蝎子的另一个特点是他们非常忠诚。它们会冒着个人风险保护彼此——你可能在第一次狩猎中已经看到过这种行为。你们最好吸取这个教训，并适应它:我们作为一个整体更强大;当我们分裂时，我们是脆弱的。给我带8个大蝎子甲壳，我将给你另一个奖励。",
    ["O"] = "带8只大蝎子甲壳给森金村的考格汉",
    ["T"] = "团结就是力量",
  },
  [814] = {
    ["D"] = "做饭和打扫——这就是我所做的一切!你想吃东西，就给我多拿点肉来!我可没有一整天的时间去打猎和准备食物给这些寄生虫吃。如果你想被平等对待你就得学着做好自己的本职工作。如果你想发挥作用，就给我弄几块野猪肉来……或者你不想饿死",
    ["O"] = "给剃刀岭的厨师托尔卡还来10块野猪肉。",
    ["T"] = "为了食物而工作",
  },
  [820] = {
    ["D"] = "真正的力量存在于你的身体中，愿意帮助一个老人炼制他的药剂。在我们的新家园中发现的慷慨和依赖盟友的力量是我们与众不同的地方，$c。我还需要一样东西才能开始配制我的药剂，八颗微光草。你可以在剃刀岭找到草药，小心，$N",
    ["O"] = "给森金村的沃纳尔大师带8个微光草。",
    ["T"] = "你依靠什么?",
  },
  [832] = {
    ["D"] = "<话语从垂坠中发出，进入你的脑海。>加祖兹?加祖兹……报告!听说你在骷髅石有发现。你必须为攻击做好准备!加祖兹，我命令你说话!快说，否则我会让尼尔鲁·火刃知道你的存在，然后他会残忍地袭击你。不要在尼尔鲁面前测试你的技能......，加祖兹，你在吗?",
    ["O"] = "带着这只眼去找尼尔鲁·火刃。",
    ["T"] = "燃烧的阴影",
  },
  [881] = {
    ["D"] = "白雾，也就是我们所说的埃其亚基，是草原狮的首领。它在捕食猎物时悄无声息地行动，就像大地上浮起的一层薄薄的白雾。它的每次出击都是一击毙命，它的猎物甚至来不及恐惧和痛苦就已魂飞魄散。你会体会到的，因为我要让你去猎杀埃其亚基。它的巢穴就在十字路口的东北边，在那些巨大的科多兽骨附近。去吧，当你走到它的巢穴附近时，就吹响这个号角，它正在等着你呢。",
    ["O"] = "把埃其亚基的皮带给十字路口的瑟格拉·黑棘。",
    ["T"] = "埃其亚基",
  },
  [969] = {
    ["D"] = "啊，我一看你就知道——你想要一个幸运符。玛艾里无所不知！!$B$B去南方。你会发现一个峡谷，那里的巨人身上有时候带有一种具有强大能量的冰块。巨人有时会带着它们，但你总是可以自己从峡谷收集碎片。这些碎片有很强的反射特性。带回来10块霜槌碎片，我的幸运符就是你的了",
    ["O"] = "为永望镇巫医玛艾里收集10个冰霜之碎片",
    ["T"] = "幸运与你同在",
  },
  [1157] = {
    ["D"] = "TODO",
  ...
  [1447] = {
    ["D"] = " 是的，你显然不是来暴风城的最聪明的人$c，但你将是永远不会离开的最愚蠢的人之一。$b$b你见过我的朋友吗?那就和我的朋友过过招吧！",
    ["O"] = "击败暴风城的达舍尔·石拳。",
    ["T"] = "失踪的使节",
  },
  [1459] = {
    ["D"] = "下一个在莱弗维奇列表上的是……让我看看……嗯。哦，在这儿。很简单，但他的指示很明确。需要荒土蝎的毒液和科多兽的毛皮。说明书上的小字写着两者都来自特定的生物:毒液来自于荒土鞭尾蝎，而毛皮则来自老迈的科多兽，注意，既不是濒死的科多兽也不是远古科多兽。$b$b,我告诉你,他们想要的东西……这太奇怪了。",
    ["O"] = "收集7瓶鞭尾蝎的毒液和3块老迈科多兽的毛皮，把它们交给凄凉之地的克雷迪格·安戈尔。",
    ["T"] = "寻物公司的委托",
  },
  [1653] = {
    ["D"] = "事实上，我想乔丹本人会非常感谢你的。我正准备找人给他送个信，让他知道他的妻子目前很安全，我想你就是个合适的人选。乔丹原本可以成为一名为圣光而战的圣骑士，不过后来为了继承他父亲的手艺走上了另一条路——他对我们的生活方式非常熟悉，也是我们最忠实的朋友。他应该还在铁炉堡，白天的时候，乔丹喜欢在室外工作，比如在山里呼吸新鲜的空气",
    ["O"] = "去和铁炉堡的乔丹·斯迪威尔谈一谈。",
    ["T"] = "正义试炼",
  },
  [2865] = {
    ["D"] = "塔纳利斯这里的圣甲虫的壳都很硬！硬得足可以给好多东西当建筑材料，好多东西！事实上，因为那些壳都太有用了……圣甲虫已经被猎杀得近乎灭绝了！我知道哪里有更多的圣甲虫，如果你保证会给我弄些壳来，我就告诉你它们在哪里。你保证吗？好吧，祖尔法拉克里面有许多圣甲虫，我想巨魔们并不因为想要那些壳而猎杀它们。但你可以！到祖尔法拉克去给我弄些完好无损的壳回来！",
    ["O"] = "给加基森的特兰雷克带去5个完整的圣甲虫壳。",
    ["T"] = "圣甲虫的壳",
  },
  [3111] = {
    ["D"] = "在你帮我的时候，有人让我把这份备忘录转交给你。有机会的话，花点时间读一下。我想它来自法师训练师马雷克。看一看，有机会就去安威玛尔找他。",
    ["O"] = "请在安威玛尔找马雷克·斯特姆努尔。",
    ["T"] = "雕文符文",
  },
  [3578] = {
    ["D"] = "我一直在等我的妻子，萨曼莎·迅蹄，她还没来呢!我很困惑…你能帮我找到她吗?上次我们交谈时，她因为看到了新的地方而非常兴奋，是从一个港口到遥远的东方王国的北部地区森林，唉，我知道附近唯一的港口就是棘齿城。我敢肯定，萨曼莎勇敢地走到渡口，并游到了藏宝海湾。我不知道她从那里可以到哪里去。也许你能帮我找到她?只是为了确定她没事……",
    ["O"] = "找到萨曼莎·迅蹄",
    ["T"] = "像雨燕一样快",
  },
  [3579] = {
    ["D"] = "是的，我独自一人走了这么远，是的，我很累，唉，我的旅行欲望太强烈了，以至于不能被忽视，我只是不能停下来，即使是一分钟，知道有那么多的道路要被发现，森林要穿越，平原要被跑过……哦，世界那么大，我可以用一生去旅行!然而，正如你所看到的，我跌倒受伤了。啊，要是有厚绷带来帮助我的肌肉恢复健康就好了",
    ["O"] = "给萨曼莎·迅蹄带来10条厚丝绸绷带，5个枯叶草，10个地根草和10个清凉的泉水。",
    ["T"] = "迅蹄的旅行",
  },
  [3580] = {
    ["D"] = "我现在感觉好多了!如此的精力充沛和兴奋!哦，这太棒了!谢谢你，$N，非常感谢。除了强大的意志和耐用的蹄子，你还需要一个风的祝福来帮助你跑得像我们所有的雨燕一样快!我认识一个牛头人，可以指导你。他叫乔恩·星眼。我上次和他说话是在南部荒原的陶拉祖营地。啊，黄金之路，如此诱人…… ",
    ["O"] = "和陶拉祖营地的乔恩·星眼谈谈。",
    ["T"] = "奔向平原，看向天空",
  },
  [3581] = {
    ["D"] = "想象一下，你在平原上飞驰，穿过森林，翻越高山，风吹过你的脸……在看不见的领域旅行;前方的道路充满奇迹，你的命运就在地平线上。永远记住，在活着的时候，许多事情是可以做到的;作为牛头人，你将获得原野疾驰技能。你可以去的距离是没有限制的",
    ["O"] = "与烈日行者赛恩 <圣骑士训练师>对话学习原野疾驰技能。",
    ["T"] = "原野疾驰",
  },
  [4297] = {
    ["D"] = "小精龙是杂食动物——它们既吃肉也吃植物。要是这颗蛋即将孵化的话，我们最好有所准备。信不信由你，这些小家伙最喜欢吃生的新鲜腰肉。我始终不明白为什么，但是这也许和艾露恩的旨意有关……或许它们将成为守护者或是别的什么，谁知道呢。我会照顾好这颗蛋，而你要负责找到一些银鬃捕猎者的肉，以便在小精龙孵化后喂食。",
  ...
  [40204] = {
    ["D"] = "问候旅行者，高级哨兵阿黛娜·奥克利夫一直在寻求泰达希尔内部事务的帮助。她已经召集了任何适合并愿意协助解决我们境内问题的人。如果您想在泰达希尔内部帮助解决问题，那么没有比这更好的地方了。阿达娜·奥克利夫就在我身后通往达纳苏斯大门的顶端。",
    ["O"] = "请听泰达西尔的Adaena Oakleaf的报道。",
    ["T"] = "与阿黛娜的会面",
  },
  [40205] = {
    ["D"] = "泰达西尔的熊怪已经变成了一个比我想象中更大的威胁。我只是把他们想象成我们的盟友，对抗任何可能给泰达希尔带来伤害的事情，而不是与他们作战。哨兵阿玛拉·夜行者的任务是巡逻道路，以确保旅行者的安全，但我担心这是不够的。如果我们希望确保我们的边境安全，我们必须采取更积极主动的方法，阻止更大威胁的积聚。熊怪人已经向东南方向聚集了一段时间了。应该很快他们就会有足够的勇气开始对多兰纳尔或幽影谷进行探测攻击。如果他们成功了，他们的勇气只会增强，从而做出更大的伤害。前往Gnarlpine Hold，杀死那里的探路者和复仇者，以确保达纳苏斯的安全",
    ["O"] = "在泰达希尔为Adaena Oakleaf杀死10名瘤背复仇者和5名瘤背探路者。",
    ["T"] = "保卫达纳苏斯",
  },
  [40206] = {
  ...
  [40230] = {
    ["D"] = "Falathim湖是我度过大部分青春时光的地方，这是一个放松和美好时光的地方。但现在它被盐沬怪占领了，他们进攻凶猛，毫无悔意。一些人在袭击中丧生，但我很幸运地逃了出来。当我要离开的时候，我留下了一件对我来说最有价值的东西。在海加尔战役中死去的叔叔给我留下了一本书。这是他写的关于他的战斗技巧和他的战争经验。我从那本书中发现了许多知识和智慧，我渴望知道他在去世前所写下的一切。去西南部的法拉希姆湖，找到我的东西。当你在那里,一定要报仇,杀Saltspittle,最好切掉它们的鳍",
    ["O"] = "收集5个盐沫入侵者的鳍并取回Greenblade Book。",
    ["T"] = "盐沫入侵者",
  },
  [40231] = {
  ...
  [40273] = {
    ["D"] = "<一阵风打开了封闭的杂志>。在海洋深处寻找星星，迷失的人在港口咧嘴笑，泪水淹没在烟草的烟雾中，欢呼声中充满了虚假的希望。我很冷，很累，我希望能睡得深，容易走过，空，我该从哪里开始，这样我才能继续?我试着接受我是谁，我是谁，我想成为什么。在我对爱无可救药的渴求中，我只有一个遗憾。<当你浏览这些页面时，诗歌似乎变得越来越黑暗>。黑暗深沉，我在寻求冷漠，淹没在痛苦中，开始和结束，困在中间，没有目的，没有目标，黑暗的天空，害羞的月亮，寒冷的夜晚，温暖的床。<翻到最后一页你不知道该怎么看>。为什么为什么为什么为什么为什么为什么是我，我做错了什么?这页上潦草地写着“为什么”，在所有的重复之上，它又写满了整页。在日志的末尾，一个名字和一条消息被转述为>。",
    ["O"] = "在暴风城找到日记的主人。",
    ["T"] = "寻找失主",
  },
  [40274] = {
  ...
  [40456] = {
    ["D"] = "嘿，$r!你看起来像是那种有教养的人，喜欢了解世界上发生的事情!嗯，我是加基森时代报纸的实习售货员!我们只报道最爆炸性的新闻!只要几个银币，你就会被认为是加基森的盟友，没错!还有有用的提示和技巧在页面中，好吧，想象一下所有的利润，现在你可以为这做微小的投资!<她向你挥舞着一卷报纸。>",
    ["O"] = "购买《加基森时报》第二版!",
    ["T"] = "《加基森时报》:阅读所有关于它的文章!",
  },
  [40457] = {
    ["D"] = "嘿，$r!你看起来像是那种有教养的人，喜欢了解世界上发生的事情!嗯，我是加基森时代报纸的专业售货员!你知道我们地精，如果一件事不值那么多金子，那它就不值得收藏。只需要几枚银币，你就可以把你的名字写下来，成为报纸的支持者和地精生意的朋友。有了里面的信息，你可以获得超乎想象的收益!就为了这么一笔小小的投资。<她傻笑着把报纸递给你。>>",
    ["O"] = "购买《加基森时报》第二版!",
    ["T"] = "《加基森时报》:阅读所有关于它的文章!",
  },
  [40458] = {
  ...
  [50315] = {
    ["D"] = "来吧，来吧，拿上你最新一期的《加基森时报》!在这里你会发现真正的爆炸性新闻!哦，有重大新闻了!很快，在闪光平原上，就像你知道的，在千针石林，两支最具冒险精神和最聪明的队伍将在一场迷人的比赛中竞争，最著名的是整个宇宙的the universe as THE MIRAGE RACES!",
    ["O"] = "拿起《加基森时报》第一期!",
    ["T"] = "加基森时报:突发新闻!!",
  },
  [50316] = {
  ...
  [60007] = {
    ["D"] = "露露警惕地盯着农场周围的狼群。你能听到她可怜的小心脏在恐惧中砰砰跳。狼群正在舔着它们的排骨，等待时机，直到它们有机会攻击。像她这样天真可爱的东西，不应该在自己家里看起来那么害怕。由你来减轻露露的痛苦。",
    ["O"] = "消灭农场里的15只狼。",
    ["T"] = "Lulu 看起来很甜美",
  },
  [60008] = {
    ["D"] = "在寒冷的月份里，我妈常给我们做一些很好的手套，让我们暖和起来。没有她，一天比一天冷，但她把制作羊毛衣服的所有知识都教给了我。如你所见，农场里到处都是羊。虽然森林里有很多，但对我来说太危险了。爸爸不能同时失去我和妈妈——那样他就只能和可怜的露露在一起了。收集几捆羊毛，这样我就可以给爸爸做保暖的衣服，我也会给你做一件小东西",
    ["O"] = "从艾尔文森林的羊身上收集20捆羊毛给Julie Osworth。",
    ["T"] = "羊毛就行",
  },
  [60009] = {
  ...
  [60030] = {
    ["D"] = "你好!$B$B你是来兑换时装币的吗? 好吧，你得需要些材料。 这是我们目前需要的……$B$B我需要清单上的所有物品，一个都不能少。确保它们没有破损和被损坏……我不好欺骗的。",
    ["O"] = "带5块亚麻布，5块轻皮革，5块孔雀石和5个小皮圈给时尚达人学徒，就可以获得一枚时尚币作为奖励。",
    ["T"] = "时尚需要牺牲",
  },
  [60031] = {
    ["D"] = "你好！$B$B你是来兑换时装币的吗? 好吧，你得需要些材料。 这是我们目前需要的……$B$B我需要清单上的所有物品，一个都不能少。确保它们没有破损和被损坏……我不好欺骗的。",
    ["O"] = "带5块毛布，5块中等皮革，5个暗影宝石和5个毛茸茸的爪子给时尚达人的学徒，就可以获得一个时尚硬币作为奖励。",
    ["T"] = "时尚需要牺牲",
  },
  [60032] = {
    ["D"] = "你好！$B$B你是来兑换时装币的吗? 好吧，你得需要些材料。 这是我们目前需要的……$B$B我需要清单上的所有物品，一个都不能少。确保它们没有破损和被损坏……我不好欺骗的。",
  ...
  [60040] = {
    ["D"] = "我发誓我现在就能吃下一个食人魔!你会去斯通菲尔德农场吗?如果是的话，你能帮我要一个斯通菲尔德奶奶家著名的艾尔文南瓜派吗?农场在这里的正西南方。如果你沿着这条路走，你就不会错过它。请回来当你有馅饼",
    ["O"] = "带1个美味的南瓜派给闪金镇的的Gina Weller。",
    ["T"] = "美味的南瓜派",
  },
  [60041] = {
  ...
  [60070] = {
    ["D"] = "信任是买不到的，$R。事情是这样的，小伙子。你赢得了这只角鹰兽的信任，你就可以乘车去营地了。失败了，他会把你当早餐吃。哈!我当然是在跟你开玩笑，小伙子。除非完全信任你，否则这只长着翅膀的野兽连挪动都不会。你会问，怎么做?当然是食物。还有一个玩具。想想看吧。",
    ["O"] = "给闪金镇Kelton的角鹰兽带来5个大块野猪肉，3个矮人奶酪和1个咀嚼玩具",
    ["T"] = "信任问题",
  },
  [60071] = {
  ...
  [60110] = {
    ["D"] = "我很痛苦地向你提出这个要求但是森林蜘蛛的母体变得越来越不友好了。她的行为威胁着暗影谷的平衡，因为她过度猎杀当地的野生动物……甚至在艾维隆徘徊在黑丝洞附近时袭击了他。把她的毒囊带回来，我好进一步研究。小心，她的毒比其他小蜘蛛都强。",
    ["O"] = "杀死邪恶的基塞伊斯 收集它的毒囊，可以在黑丝洞穴深处找到它。",
    ["T"] = "邪恶的基塞伊斯",
  },
  [60111] = {
    ["D"] = "你已经证明了自己有足够的能力协助我们对付他们的首领，阿高尔和绿爪，$C。我们的侦察兵已经确定了他们的位置。首先是阿加尔，他在地下的一个洞穴里指挥伏击。第二个是绿爪，一个强大的萨满，他从内部对班尼希尔巢穴进行恐吓。他们身边都是各自的下属。我建议你带上一个盟友，或者准备独自一人杀出一条血路。无论你的决定如何，愿艾露恩保护你。",
    ["O"] = "哨兵阿玛拉·夜行者要求你在通往达纳苏斯和绿爪之路下方的洞穴中杀死阿高尔。",
    ["T"] = "决定性的一击",
  },
  [60112] = {
  ...
  [60124] = {
    ["D"] = "Ishnuallah, $ C。这片荒地正在酝酿着麻烦。不,它不是部落或半人马,这是哀号洞穴。它试图把贫瘠的土地变成郁郁葱葱的绿洲，但却事与愿违。纳拉雷克斯试图利用翡翠之梦的力量，但噩梦先他一步，让他进入永恒的睡眠，腐蚀每一个野兽，甚至他的助手!你可以在北部的荒原上找到哀嚎洞穴。在洞穴里找到他的门徒，他会告诉你如何解救他。",
    ["O"] = "奥兰达利亚·夜歌想让你冒险进入北方荒原的哀嚎洞穴，将纳拉雷克斯从梦魇中解放出来。在洞穴里找到他的弟子学习如何。释放纳拉克雷斯后再回到她身边",
    ["T"] = "陷入噩梦",
  },
  [60125] = {
    ["D"] = "虽然你的主要任务是从噩梦中拯救纳拉雷克斯，但我们从中可能会了解到更多关于哀嚎洞穴的腐败。据说，一种名为毒药花的植物在纳拉雷克斯进入永恒的睡眠后在洞穴中发芽，它们含有蛇的毒液。我想让你冒险进入洞穴，给我带来10棵这样的植物。",
    ["O"] = "奥伯丁的奥兰达利亚·夜歌派你去收集10个毒蛇花.",
    ["T"] = "毒蛇花",
  },
  [60130] = {
  ...
  [60141] = {
    ["D"] = "对于暴风城的贵族来说，圣骑士是精锐战士，他们的荣耀来自于战场上的表现。但我们追随光明的人更清楚。对于王国的穷人，我们唯一的安慰常常是来自援助。正是这些简单的帮助和照顾的任务区分了一个真正的圣骑士和一些拿着棍棒的傻瓜。在东谷伐木营地有一个苦苦挣扎的家庭，他们需要帮助来度过这一年。我本想自救，但我不能离开闪金镇，因为我们周围有这么多威胁。如果你能代替我帮助他们，去猎杀路南边发现的岩皮野猪然后把它们的肉带到伐木营地",
    ["O"] = "目标: 给东谷伐木场的艾尔丁",
    ["T"] = "信仰之光",
  },
  [60142] = {
  ...
  [60143] = {
    ["D"] = "你是否曾站在泰达西尔的边缘，眺望迷雾之海?这是一个壮观的景象，$N -你应该试试看!我曾经带着我的针线包去涌泉湖附近的瀑布，当它们倾泻在树干的一侧时，在平静和宁静中做我的工作。但是上次我在那里的时候，我被一群疯狂的森林人袭击了，没带我的装备就被赶走了!这些工具带在我身边很久了，一想到它们滚到海里，永远消失在海里，我就受不了。你能帮我找回来吗?",
    ["O"] = "找回布兰诺的针线包，并在多兰纳尔把它还给他。",
    ["T"] = "布兰诺的针线包",
  },
  [60145] = {
  ...
  [60154] = {
    ["D"] = "在你完成了玉石矿洞的侦察任务后，我收到了报告，一群来自暮色森林的流浪蜘蛛把矿井深处当作了它们的家，同时利用狗头人来喂养和增加它们的人口。狗头人，反抗者，现在又来了蜘蛛?我们不再能分散我们本就单薄的人力了。快到矿洞深处去，在它们蔓延到整个森林之前把它们清除掉!",
    ["O"] = "去闪金镇东北部的玉石矿洞清除蜘蛛的侵扰。然后回闪金镇的杜治安官杜汉那里。",
    ["T"] = "玉石矿洞的虫害",
  },
  [60155] = {
  ...
  [80200] = {
    ["D"] = "啊，你醒了。从洛丹伦残部向南的旅程充满了危险，但我们幸存了下来，这里是我们的新家。既然我们已经到了，还有许多工作要做。自第二次战争以来，这个小屋只被少数矮人猎人使用过，但它一直没有得到妥善的维护。旅馆的维林·疾风在这里待的时间比我们都长。为什么不先和她谈谈呢?",
    ["O"] = "和旅行者营地的维林·疾风谈谈。",
    ["T"] = "旅行者营地",
  },
  [80201] = {
    ["D"] = "满载难民的马车从北方赶来，我们知道还有更多的人在路上。因为这里曾被用作矮人狩猎小屋，所以储藏室里放满了肉。不幸的是，大部分的肉都在腌制过程中，而小屋没有足够的柴火。出去收集一些吧。你可以在小屋外面找到很多捆成捆的木头。对了，还有个警告别离开山谷。外面的事情非常危险，而你还没有准备好面对它们。",
    ["O"] = "在旅行者营地外面收集8捆木头",
    ["T"] = "囤积木材",
  },
  [80203] = {
    ["D"] = "不好意思，$R，能占用你一点时间吗?我是凯西。我是联盟军事分支的一员负责确保联盟领土的安全和繁荣。我们最近被派来了一大批人。虽然我个人认为我们的家乡需要更多的人，但我不应该质疑命令。我们的任务是确保你们的人安全抵达旅馆，并让你们安顿下来。然而,很难保证每个人的安全。当我的人在处理这个地区的大问题时，小问题已经被忽视太久了，现在他们越来越猖獗。如果不尽快采取行动，难民车队可能会处于危险之中。我认为你能战斗吗?如果是这样的话，请去消灭那些在旅馆周围肆虐的troggs。",
    ["O"] = "杀死 8 Trogg Vermin.",
    ["T"] = "清除害虫",
  },
  [80204] = {
    ["D"] = "你现在不那么嫩了，这很好。与潜伏在这个山谷里的其他东西相比，你打败的害虫只是一个讨厌的东西。昨晚抵达的一些难民报告说，他们看到一个身材矮小、眼睛通红的人在树林里悄悄靠近该地区。有些人认为这是长途旅行的疲劳，但我相信这可能是暗影熔炉突袭队的前锋侦察兵。暗影熔炉是黑铁氏族之一。他们是堕落的红眼矮人，与铁炉堡王国格格不入。调查目击事件发生的西面区域，但不要离地点太近。那里到处都是比你之前打过的那些害虫更强壮的穴居怪。记住:不要交战。如果你发现了什么，确认你的发现，然后马上回到这里。",
    ["O"] = "调查旅行者营地西南方向的区域。",
    ["T"] = "收集情报",
  },
  [80205] = {
    ["D"] = "你好，$N。你收集的木材帮助了许多难民。然而，局势远未得到解决。饮用水储备快用完了。很快，我们将无法照顾难民，但幸运的是，在这个山谷的边界附近有一口井。去那儿，把这个桶装满水。有志愿者试图在这里挖一口新井，但这需要时间。拜托，$N，我知道我可以相信你!",
    ["O"] = "用井里的水把空桶装满。",
    ["T"] = "解渴",
  },
  [80206] = {
    ["D"] = "<维林·疾风看着你的方向，显得很苦恼>。我们在附近发现一辆被烧毁的马车，车上有随行护送人员的尸体，没有难民的踪迹。它…太可怕了，$N，太可怕了!请和你的同伴玛尔维娜谈谈，好吗?我在想办法让大家保持冷静，但她很不安。她在难民中传播恐慌和混乱",
    ["O"] = "和马尔维娜·日刃谈谈，然后向凯西·维克汇报。",
    ["T"] = "烧焦的车轮",
  },
  [80207] = {
    ["D"] = "好吧，$N，计划是这样的。我们在黑铁营地周围建立了防线，但我们相信，如果我们行动起来，他们就会处决难民。我们接到了撤退的命令。但是，如果我们现在不采取行动，难民就会被杀害。我们需要一个人潜入他们的营地，杀死火祭司，拿到牢房的钥匙，解救难民。我想不出有谁比你更胜任这个任务了。在我们认识的短短时间里，你已经证明了自己的坚强和足智多谋。我相信你，$N!现在去救那些人吧!",
    ["O"] = "杀死暗影熔炉的火祭司，获得黑暗之钥并释放高等精灵难民。",
    ["T"] = "黑铁报废",
  },
  [80208] = {
    ["D"] = "你是我们的的英雄，$N!所有的难民都在喊你的名字!我相信你有个朋友特别感激你。为什么不去和玛尔维娜·日刃谈谈?",
    ["O"] = "跟马尔维娜·日刃谈谈。",
    ["T"] = "日刃重逢",
  },
  [80209] = {
    ["D"] = "那么你已经决定要帮忙了?我很感激，$N!家乡的情况很糟糕，我们现在不能回去帮助他们。我不知道暴风城的贵族们遭受了怎样的折磨，但自从瓦里安国王失踪后，这个王国就彻底完蛋了!唉，虽然我们不能控制贵族，但我们可以处理王国各省的问题!艾尔文森林是个不错的开始。首都位于这一地区，它一直被问题所包围。狗头人控制矿山，豺狼人袭击城镇，土匪占领道路。我的朋友杜汉元帅驻扎在闪金镇，他能让你派上用场。我相信这位法师能把你传送到闪金镇。",
    ["O"] = "与Magistrix Ishalah对话，让她传送到闪金镇，然后向治安官杜汉报告",
    ["T"] = "前往闪金镇",
  },
  [80210] = {
    ["D"] = "你好,$ N !到目前为止，你已经取得了惊人的进步，但还有很多事情要做。虽然旅馆里储存了大量的谷物和肉类，但我们缺乏其他类型的营养，如水果和蔬菜。幸运的是，小屋周围的地区每年这个时候都有大量的南瓜和浆果。我能指望你在这片区域搜寻浆果和南瓜吗?我们人民的幸福就靠它了!",
    ["O"] = "在旅行者营地周围收集4个莫丹湖南瓜和8个莫丹湖浆果.",
    ["T"] = "均衡饮食",
  },
  [80211] = {
  ...
  [80217] = {
    ["D"] = "为了向我证明你自己，$N，你去小屋周围找找那些在这附近安家的野猪和熊的幼崽。你的亲属还需要用他们的兽皮做的衣服和盔甲。虽然我不是最好的皮革工人，但我仍然可以制作一些工具。五张小熊皮和五块小猪肉就足以证明你的价值了。等你什么都准备好了再来",
    ["O"] = "给旅行者营地的马雷克·铁心带5块小熊皮和5块小野猪肉",
    ["T"] = "毛皮和长牙",
  },
  [80219] = {
  ...
  [80250] = {
    ["D"] = "加油，malanore， $R!我代表的是一群试图恢复我们昔日荣光的人民。我们正在为自己寻找一个新家，非常欢迎你的帮助。当你有时间时，前往暴风城并与暴风要塞的Caledra Dawnbreeze交谈。相信你会因为你的帮助而得到很好的回报!",
    ["O"] = "与暴风城的Caledra Dawnbreeze对话。",
    ["T"] = "协助太阳之子",
  },
  [80251] = {
    ["D"] = "既然你知道了我们正在处理的事情和我们的历史……是时候采取行动了。如果你真的有兴趣帮助我们，那就这样吧。我们最有才华的法师之一已经建立了与塔纳利斯的灵魂连接。去法师区的法师塔，和艾尔沙林对话。她会带你去的，一旦你到了，我相信会有人照顾你的。",
    ["O"] = "与爱尔莎林对话，她在暴风城法师塔的传送门处。",
    ["T"] = "到塔纳利斯!",
  },
  [80252] = {
  ...
  [80391] = {
    ["D"] = "你好!欢迎您的光临。我是Moa\'ki Harbor的Iunquaq。经过几周的航行，我发现自己来到了这个陌生的地方。我的故事开始于我的一个名叫Buniq的牛头人朋友乘独木舟来我的定居点，她邀请我陪她去Taunka\`le村。但当我进入独木舟时，一阵强烈的冷风把Buniq手中的绳子吹走了。不一会儿，一股强劲的水流把我带到了大海上!Buniq拿着桨，所以我能做的就是拼命地抓住独木舟，抱着最好的希望。最终水流把我带到这片温暖的土地，这里看起来一点也不像我的家。听着，朋友，独木舟上有一些食物但我几天前就吃完了。你能从这些有壳的动物身上收集一些肉吗?我们在遥远的北方也有类似的生物，但我没有所需的工具和知识去尝试接近它们，据我所知，它们是可食用的。如果你这么做，我将永远欠你人情。",
    ["O"] = "收集8串螃蟹肉。",
    ["T"] = "螃蟹肉",
  },
  [80392] = {
